...
\begin{document}
  ...
  \centerline{web applications in agency and startup settings}
	...
	\begin{resume}
      ...
      {\bf Related Technologies:} Shopify, CircleCI, Heroku Pipelines, Elasticsearch, APM (Sentry, New Relic, Structured Logging), AWS (S3, EC2, Lambda, API Gateway, IAM, CloudFront, RDS, SageMaker)
