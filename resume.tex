...
\begin{center}
    ...
    \small Senior Software Engineer with 8 years of experience building AI-driven systems, architecting scalable \\ \vspace{1pt}
    \small web applications, and delivering high-impact solutions in fast-paced startup environments
\end{center}
...
\section{Experience}
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      ...
      {Reforge (Ed‑Tech SaaS)}{Remote / Minneapolis}
      \resumeItemListStart
        \resumeItem{\textbf{Invented} an AI‑driven recommender pipeline (OpenAI + Pinecone) powering personalised content \emph{swimlanes}; raised homepage CTR \textbf{20\%} within 8 weeks.}
        \resumeItem{\textbf{Architected} an event‑sourced GraphQL service ingesting \textgreater2 M user events/mo and responding in \textless200 ms (Go batch workers, Rails API, Apollo Client).}
        \resumeItem{\textbf{Streamlined} CI/CD by containerising services and adopting AWS Copilot + Terraform; cut mean deploy time from 25 → 15 min (\textbf{40\%}).}
        \resumeItem{Integrated Pino, Datadog APM, and Sentry to push MTTR down \textbf{60\%}; authored run‑book SOPs adopted org‑wide.}
        \resumeItem{Mentored 3 mid‑level engineers on LLM prompt‑engineering and TypeScript best practices.}
      \resumeItemListEnd
    ...
    \resumeSubheading
      ...
      % TODO: add bullet about assisting a cohort of 30 students
      % TODO: add bullet about teaching react, nodejs, html, css
...
\section{Technical Skills}
  \begin{itemize}[leftmargin=0.15in,label={}]
    \small{\item{
      \textbf{Languages:} Ruby, TypeScript/JavaScript, SQL, Bash \\
      \textbf{Back-End:} Ruby on Rails, Node.js (Express), GraphQL (Apollo), Sidekiq, BullMQ \\
      \textbf{Front-End:} React, Next.js, Vue, Redux, TailwindCSS \\
      \textbf{Cloud / DevOps:} Docker, GitHub Actions, AWS (ECS, Lambda, RDS, S3, IAM, CloudFront), Traefik \\
      \textbf{Data \& AI:} PostgreSQL, Redis, Vector Databases (Pinecone), Vercel AI, LangChain, Sentry/New Relic (APM),
    }}
  \end{itemize}
