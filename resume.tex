  ...
  \centerline{web applications in agency and startup settings}
	...
	\begin{resume}
      ...
      {\bf Related Technologies:} Shopify, CircleCI, Heroku Pipelines, APM (Sentry, New Relic, Structured Logging), AWS (S3, EC2, Lambda, API Gateway, IAM, CloudFront, RDS, SageMaker)
        ...
        \item Designed and implemented a custom e-commerce model that was able to consolidate 3 separate payment systems used in our studios and on our website, increasing reliability and extensibility
        ...
        \item Automated time-intensive pre-appointment flow, saving hours of effort per appointment and improving overall efficiency
        ...
        \item Streamlined the capture of tattoo images and associated meta-data from 3rd party service via automated upload and tagging, enhancing data management and accessibility
			\end{itemize}
