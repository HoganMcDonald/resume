...
\begin{document}
  ...
  \centerline{Senior Software Engineer with 6 years of experience architecting, developing, testing, and maintaining}
  \centerline{web applications in agency and startup settings}
	...
	\begin{resume}
      ...
      {\bf Related Technologies:} Shopify, CircleCI, Heroku Pipelines, APM (Sentry, New Relic, Structured Logging), AWS (S3, EC2, Lambda, API Gateway, IAM, CloudFront, RDS, SageMaker)
		...
		{\bf Ephemeral Tattoos, Remote} \hfill \emph{July 2022 - Present} \\
			\emph{Senior Software Engineer}

			\begin{itemize} \itemsep -2pt
        \item Architected and led the development of all backend projects to support the needs of stakeholders on growth and operations teams
        \item Introduced observability tools, reducing response time from days to minutes, enabling prompt identification and resolution of performance bottlenecks and eliminating all sources of regular downtime
        \item Automated labor-intensive pre-appointment flow, saving thousands of hours of labor per month and improving overall efficiency
        \item Designed and implemented a custom ecommerce flow that was able to consolidate 3 seperate payment systems used in our studios and on our website, increasing reliability and extensibility
        \item Spearheaded development of a group booking feature, leading to a doubled conversion rate and improved customer satisfaction
